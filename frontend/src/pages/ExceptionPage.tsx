...
const ExceptionPage: React.FC = () => {
  ...
  const operationTypeLabels: Record<OperationType, string> = {
    ...
    [OperationType.CUSTOMS_DRAW]: '海关抽中',
    [OperationType.CUSTOMS_INSPECT]: '开始查验',
    [OperationType.CUSTOMS_PASS]: '查验通过',
    [OperationType.CUSTOMS_HOLD]: '查验暂扣',
    [OperationType.PARTIAL_RELEASE]: '部分放行',
    [OperationType.JOIN_QUEUE]: '加入排队',
    [OperationType.LEAVE_QUEUE]: '离开排队',
    [OperationType.REQUEUE]: '重新排队',
    [OperationType.QUEUE_RECALCULATE]: '队列重算',
    [OperationType.WINDOW_RECALCULATE]: '窗口重算',
    [OperationType.VOUCHER_REISSUE]: '凭证重开',
